      ...
      >
        <div className="relative flex-1">
          <Input
            ...
            ref={ref}
            className={cn(
              "flex h-12 w-full rounded-lg border border-input bg-background px-4 py-6 text-base shadow-sm pr-36", // Significantly increased right padding to ensure buttons are visible
