...
const BulkTagProcessor: React.FC<BulkTagProcessorProps> = ({ open, onClose, onComplete }) => {
  ...
  const fetchUnprocessedTranscripts = async () => {
    ...
    try {
      ...
      if (data) {
        // Filter out transcripts that are already processed, if unprocessedOnly is true
              ...
              <div className="flex items-center space-x-2">
                <Checkbox 
                  ...
                  onCheckedChange={(checked) => {
                    ...
                    // Re-fetch transcripts with the new setting
